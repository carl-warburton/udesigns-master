...
class UserProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post user_profiles_url, params: { user_profile: { age: @user_profile.age, hometown: @user_profile.hometown, instagram: @user_profile.instagram, name: @user_profile.name, portfolio: @user_profile.portfolio } }
    end
  ...
  test "should update user_profile" do
    patch user_profile_url(@user_profile), params: { user_profile: { age: @user_profile.age, hometown: @user_profile.hometown, instagram: @user_profile.instagram, name: @user_profile.name, portfolio: @user_profile.portfolio } }
